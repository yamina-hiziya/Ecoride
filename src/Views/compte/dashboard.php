...
if (isset($_SESSION['user'])): ?>
    <h2>Bonjour <?= htmlspecialchars($_SESSION['user']['prenom'] ?? '') ?> <?= htmlspecialchars($_SESSION['user']['nom'] ?? '') ?> !</h2>
    <p>Votre email : <?= htmlspecialchars($_SESSION['user']['email']) ?></p>
<?php endif; 
...
if (!$test['success']) {
    echo '<div class="alert alert-danger text-center" role="alert">
            <i class="fas fa-times-circle me-2"></i>' . htmlspecialchars($test['message']) . '
          </div>';
} else {
    echo '<div class="alert alert-success text-center" role="alert">
            <i class="fas fa-check-circle me-2"></i>' . htmlspecialchars($test['message']) . '
          </div>';
}
